...
$perdium_trans = $pdo->query("
    SELECT p.*, 
           ...
           o.taamagoli AS owner_taamagoli,
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Get taamagoli from budget_owners
    ...
    try {
        ...
        // 2) Insert perdium transaction - Now includes taamagoli
        $stmt = $pdo->prepare("
...
<body class="text-slate-700 flex bg-gray-100 min-h-screen">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select name="budget_owner_id" id="budget_owner_id" required class="w-full select2">
                ...
                <?php foreach ($owners as $o): ?>
                  <option value="<?php echo $o['id']; ?>" data-taamagoli="<?php echo htmlspecialchars($o['taamagoli']); ?>">
            ...
            <div>
              ...
              <select name="employee_id" id="employee_id" required class="w-full select2">
                ...
                <?php foreach ($employees as $e): ?>
                  <option value="<?php echo $e['id']; ?>" data-salary="<?php echo $e['salary']; ?>" data-directorate="<?php echo htmlspecialchars($e['directorate']); ?>">
                    <?php echo htmlspecialchars($e['name_am'] . ' - ' . $e['directorate'] . ' (' . $e['salary'] . ' Birr)'); ?>
                  </option>
                <?php endforeach; ?>
              </select>
            </div>
            ...
            <div class="program-card p-4 rounded-lg">
              ...
              <div class="flex items-center">
                ...
                <div>
                  <p id="program_taamagoli_display" class="text-sm font-medium text-gray-900">-</p>
  ...
  <script>
    ...
    function calculatePerdium() {
      ...
      if (!selectedEmployee.value || !selectedCity.value || totalDays < 1) return;
    ...
    // Update remaining budget when owner or month changes
    $('#budget_owner_id, #et_month').on('change', function() {
      loadPerdiumRemaining();
    });
  </script>

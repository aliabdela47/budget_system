...
<body class="text-slate-700 flex bg-gray-100 min-h-screen">
  ...
  <script>
    ...
    function calculateFuel() {
      ...
      const refuel = journey > 0 ? (journey / 5.0) : 0.0;
    ...
    function loadFuelRemaining(){
      ...
      if (type === 'program') {
        ...
        // Dedicated wrapper for fuel (code 5)
        $.get('get_remaining_fuel.php', { owner_id: ownerId, month: etMonth, year: year }, function(resp){
          try {

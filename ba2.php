...
// Define Ethiopian months and quarter mapping
$etMonths = ['መስከረም', 'ጥቅምት', 'ህዳር', 'ታኅሣሥ', 'ጥር', 'የካቲት', 'መጋቢት', 'ሚያዝያ', 'ግንቦት', 'ሰኔ', 'ሐምሌ', 'ነሐሴ', 'ጳጉሜ'];
$quarterMap = [
    'ሐምሌ' => 1, 'ነሐሴ' => 1, 'መስከረም' => 1,
    'ጥቅምት' => 2, 'ህዳር' => 2, 'ታኅሣሥ' => 2,
    'ጥር' => 3, 'የካቲት' => 3, 'መጋቢት' => 3,
    'ሚያዝያ' => 4, 'ግንቦት' => 4, 'ሰኔ' => 4, 'ጳጉሜ' => 4
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $year = date('Y', strtotime($adding_date)) - 8; // Adjust for Ethiopian calendar
                ...
                <form method="post" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="yearly_amount" class="input-group" value="<?php echo $budget ? $budget['yearly_amount'] : ''; ?>">
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($budgets as $b): ?>
                                <tr class="border-b border-slate-200 hover:bg-slate-50">
                                    ...
                                    <td class="px-4 py-2 ethiopic-font"><?php echo $b['month']; ?></td>

    ...
    <div class="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl overflow-hidden card-hover">
        ...
        <div class="bg-gradient-to-r from-primary to-secondary text-white pt-10 px-10 text-center">
          ...
          <!--      <img src="images/bureau-logo.png" alt="Bureau Logo" 
                     ...
                     -->
                              <!-- Option 1: Thin border version (1px) -->
              ...
              <!--    <img src="images/bureau-logo.png" alt="Bureau Logo" 
                     class="bureau-logo h-24 w-24 object-contain border border-white border-opacity-30 rounded-lg"
                     onerror="this.src='https://via.placeholder.com/96/4f46e5/ffffff?text=B'">       
                     -->
            </div>
                        <h3 class="text-3xl font-normal mb-2">Q.A.R.D Qaafiyat Biirok</h3>
            <h3 class="text-3xl font-bold mb-2">Integrated Financial System</h3></br>
            <p class="text-blue-100 pb-8">Sign in to your account</p>
                ...
                <!-- Option 2: No border version (uncomment to use) -->
                <!--
                <img src="images/bureau-logo.png" alt="Bureau Logo" 
                     class="bureau-logo h-24 w-24 object-contain"
                     onerror="this.src='https://via.placeholder.com/96/4f46e5/ffffff?text=B'">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="username" name="username" type="text" required 
                            ...
                            placeholder="Isi Doqaysimê Migaq Culus">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required 
                            class="input-group py-3 px-10 block w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-0"
                            placeholder="Isi sirri loowo culus">
                    </div>
                </div>

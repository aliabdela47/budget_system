...
<head>
    ...
    <style>
        ...
        body {
            font-family: 'Inter', sans-serif; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%);
            min-height: 100vh; color: #334155; display: flex;
        }
        .main-content { flex: 1; }
        .glass-effect { background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); }
        .card-hover { transition: all 0.3s ease; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); }
            ...
            <div class="glass-effect flex flex-col md:flex-row justify-between items-start md:items-center mb-8 p-6 rounded-2xl shadow-sm">
                <div>
                    ...
                    <div class="flex items-center mt-4 bg-indigo-100 rounded-xl p-3 max-w-md shadow-inner">
                        ...
                        <span class="text-indigo-800 font-semibold" id="currentDateTime">Loading date and time...</span>
                    </div>
                </div>

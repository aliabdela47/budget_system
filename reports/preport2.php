...
<p class="header-main-title">
  <strong>
    ...
    <span class="program-budget-text">( Program Budget )</span>
  </strong>
</p>
    ...
    <div class="input-wrapper">
        <input type="text" id="qasbikinnihgide" name="qasbikinnihgide" value="<?php echo number_format((float)$transaction['emp_salary'], 2) . ' ብር'; ?>" style="font-weight: bold;">
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="safar_sababa" name="safar_sababa" value="Lowsis kee Agaarad Taama" style="font-weight: bold;">
                        </div>
                    </div>
...
<p class="header-main-title">
  <strong>
    ...
    <span class="government-budget-text">( Program Budget )</span>
  </strong>
</p>
                    </div>
                </header>

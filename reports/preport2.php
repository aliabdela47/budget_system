...
<head>
    ...
    <title>Per Diem Form - Doolat Taamabeynih Assenti Esserih Cibta ( Program Budget )</title>
    <style>
...
<div class="field-group">
    <label for="project_migaq_kee_koox">Taamagoli:</label>
    <div class="input-wrapper">
        <input type="text" id="project_migaq_kee_koox" name="project_migaq_kee_koox" value="<?php echo htmlspecialchars($project_migaq_kee_koox); ?>" style="font-weight: bold;">
        </div>
        </div>
    ...
    <div class="field-group">
        <label>Cisaab Diggosse Migaqa:</label>

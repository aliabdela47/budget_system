...
<body>
    ...
    <div class="input-wrapper">
        <input type="text" id="project_migaq_kee_koox" name="project_migaq_kee_koox" value="<?php echo htmlspecialchars($transaction['budget_owners'] ?? ''); ?>" style="font-weight: bold;">
        </div>
</div>
<div class="field-group">
  <label for="taamabeyni_migaq_1">4. Taamabeyni Migaq:</label>
                        ...
                        <div style="margin-left: 20px; margin-top: 10px;">
                            ...
                            <div style="display: flex; gap: 40px;">
                               ...
                               <div class="field-group" style="flex:1;">
                                   ...
                                   <div class="input-wrapper">
                                       <input type="text" id="sittatmekleenim" name="sittatmekleenim" value="<?php echo number_format($total_amount, 2); ?>" style="font-weight: bold;">
                                   </div>
                               </div>
                            </div>
                        </div>
    ...
    <div class="input-wrapper">
        <input type="text" id="taamagoli_2" name="taamagoli_2" value="<?php echo htmlspecialchars($transaction['budget_owners'] ?? ''); ?>" style="font-weight: bold;">
    </div>
    </div>
    <div class="field-group">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" value="06:00 AM" style="font-weight: bold;"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" value="06:00 PM" style="font-weight: bold;"></td>
                                <td><input type="text" value="<?php echo number_format($perdium_rate * 0.1, 2); ?>" style="font-weight: bold;"></td>
                                <td><input type="text" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>" style="font-weight: bold;"></td>
                                <td><input type="text" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>" style="font-weight: bold;"></td>
                                <td><input type="text" value="1" style="font-weight: bold;"></td>
                            ...
                            <tr class="row-total">
                                ...
                                <td><input type="text" value="<?php echo number_format($total_per_diem_amount, 2); ?>" style="font-weight: bold;"></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
                        <div style="width: 40%;">
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" id="sittat_final" name="sittat_final" readonly value="<?php echo number_format($total_per_diem_amount, 2); ?>" style="font-weight: bold;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="signature-section">
                        <div class="field-group"><label for="taama_gexanum_migaqa">Taama Gexanum Migaqa:</label><div class="input-wrapper"><input type="text" id="taama_gexanum_migaqa" name="taama_gexanum_migaqa" value="<?php echo htmlspecialchars($transaction['employee_name']); ?>" style="font-weight: bold;"></div><label for="taama_gexanum_firma">Firma:</label><div class="input-wrapper"><input type="text" id="taama_gexanum_firma" name="taama_gexanum_firma" style="font-weight: bold;"></div></div>
                        <div class="field-group"><label for="cisaab_massose_migaqa">Cisaab Massose Migaqa:</label><div class="input-wrapper"><input type="text" id="cisaab_massose_migaqa" name="cisaab_massose_migaqa" style="font-weight: bold;"></div><label for="cisaab_massose_firma">Firma:</label><div class="input-wrapper"><input type="text" id="cisaab_massose_firma" name="cisaab_massose_firma" style="font-weight: bold;"></div></div>
                        <div class="field-group"><label for="diggosse_migaqa">Diggosse Migaqa:</label><div class="input-wrapper"><input type="text" id="diggosse_migaqa" name="diggosse_migaqa" style="font-weight: bold;"></div><label for="diggosse_firma">Firma:</label><div class="input-wrapper"><input type="text" id="diggosse_firma" name="diggosse_firma" style="font-weight: bold;"></div></div>
                        <div class="field-group"><label for="fatiicisee_migaqa">Fatiicisee Migaqa:</label><div class="input-wrapper"><input type="text" id="fatiicisee_migaqa" name="fatiicisee_migaqa" style="font-weight: bold;"></div><label for="fatiicisee_firma">Firma:</label><div class="input-wrapper"><input type="text" id="fatiicisee_firma" name="fatiicisee_firma" style="font-weight: bold;"></div></div>
                    </div>
                </main>
            </div>

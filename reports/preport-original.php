...
<div class="header-bottom">
    ...
    <div class="value">
        <span style="font-weight: bold; border-bottom: 1.5px solid #000; display: block; padding: 1px 3px;"><?php echo htmlspecialchars($transaction['owner_name']); ?></span>
    </div>
</div>
<div class="field-group">
    <label for="project_migaq_kee_koox">3. Project Migaq Kee Koox:</label>
    <div class="input-wrapper">
        <input type="text" id="project_migaq_kee_koox" name="project_migaq_kee_koox" value="<?php echo htmlspecialchars($transaction['project_migaq_kee_koox']); ?>" style="font-weight: bold;">
        </div>
        </div>
        <div class="field-group">
  <label for="taamabeyni_migaq_1">4. Taamabeyni Migaq:</label>
                     ...
                     <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="qasbikinnihgide" name="qasbikinnihgide" value="<?php echo htmlspecialchars($transaction['emp_salary']); ?>" style="font-weight: bold;">
                        </div>
                    </div>
                    <div class="field-group">
    ...
    <div class="input-wrapper">
        <input type="text" id="taamagoli_2" name="taamagoli_2" value="<?php echo htmlspecialchars($transaction['owner_name']); ?>" style="font-weight: bold;">
    </div>
    </div>
    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="qasbi_kinnihgide_2" name="qasbi_kinnihgide_2" value="<?php echo htmlspecialchars($transaction['emp_salary'],); ?>" style="font-weight: bold;">
                        </div>
                    </div>
                    <div class="field-group">
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-top: 8px;">
                        <div style="width: 40%;">
                            <div class="field-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" id="a_kee_b_sittat" name="a_kee_b_sittat" readonly value="<?php echo number_format($total_final_amount, 2); ?>" style="font-weight: bold;">
                                </div>
                            </div>
                            <div class="field-group">
    ...
    <span id="sittat_final" style="font-weight: bold; border-bottom: 1.5px solid #000; display: block; padding: 1px 3px;">
        <?php echo number_format($table_total_last_col + $total_travel_allowance, 2); ?>
                    ...
                    <div class="signature-section" style="display: grid; grid-template-columns: 1fr 1fr; gap: 5px 15px;">
                        <div class="field-group"><label>Taama Gexanum Migaqa:</label><div class="input-wrapper"><input type="text" value="<?php echo htmlspecialchars($transaction['emp_name']); ?>"></div></div>

...
<div class="field-group">
  <label for="taamabeyni_migaq_1">4. Taamabeyni Migaq:</label>
    ...
    <div class="input-wrapper">
        <input type="text" id="taamagoli_2" name="taamagoli_2" value="<?php echo htmlspecialchars($transaction['budget_owner_id']); ?>" style="font-weight: bold;">
    </div>
    </div>
    <div class="field-group">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" value="12:00 ጧት" style="font-weight: bold;"></td>
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-top: 8px;">
                        <div style="width: 40%;">
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" id="sittat_final" name="sittat_final" readonly value="<?php echo number_format($total_per_diem_amount + $total_travel_allowance, 2); ?>" style="font-weight: bold;">
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <?php foreach ($transactions as $transaction): ?>
        <div class="report-container">
            ...
            <section class="sub-header">
                <p style="font-size: 1.1rem; font-style: normal; font-weight: bold;">Biiro Makaayinih Suktay Zeytiy Kee Gersi Gacamgac Uwwaytih damiyyi Essero Cibu</p>
            ...
            <section class="transaction-details">
                <div class="details-grid">
                    ...
                    <p><strong>የሹፌር ስም (Driver):</strong> <span style="font-size: 1.1rem; font-weight: bold;"> <?php echo htmlspecialchars($transaction['driver_name']); ?></span></p>
                    <p><strong>የተሽከርካሪው ታርጋ:</strong> <span style="font-size: 1.1rem; font-weight: bold;"><?php echo htmlspecialchars($transaction['plate_number']); ?></span></p>
                    ...
                    <p><strong>የሚጓዘው ርቀት (Distance):</strong> <span style="font-size: 1.1rem; font-weight: bold;"><?php echo number_format($transaction['journey_distance'], 2); ?> km</span></p>
                    <p><strong>የነዳጅ ዋጋ (Price/Liter):</strong> <span style="font-size: 1.1rem; font-weight: bold;"><?php echo number_format($transaction['fuel_price'], 2); ?> Birr</span></p>
                    <p><strong>የተሞላ ነዳጅ (በሊትር):</strong> <span style="font-size: 1.1rem; font-weight: bold;"><?php echo number_format($transaction['refuelable_amount'], 2); ?> L</span></p>
                    <p><strong> የሚያስፈልገው ገንዘብ(Total Cost):</strong> <span style="font-size: 1.1rem; font-weight: bold;"><?php echo number_format($transaction['total_amount'], 2); ?> Birr</span></p>
                </div>
            </section>

...
$B = $A * max(0, ($total_days - 2)); // Use max(0, ...) to avoid negative values
$C = $A;
$D = $perdium_rate * max(0, ($total_days - 1)) * 0.4;
    ...
    <form class="editable-form" method="POST" action="/submit-perdium">
        <div class="report-container">
            <div class="page" id="page1">
                ...
                <main>
<!-- for 1. Biiro Migaq: Set Fixed Lable "Q.A.R.D Qaafiyat Biiro" with bold text the text is the Name of the Bureau, thats why it has to be set Fixed text it is not found in the database -->                  
                  <div class="field-group">
                        <label for="Biiro Migaq">5. Safar Sababa:</label>
                  ...
                  <div class="field-group">
                    <label>2. Taamagoli:</label>
                      <div class="value">
                          <span><?php echo htmlspecialchars($transaction['owner_owners']); ?> - <?php echo htmlspecialchars($transaction['budget_owners']); ?></span>
                      </div>
                  </div>
 <!-- for 3. Project Migaq Kee Koox: is the same as 2. Taamagoli set it's content with bold text -->                   
                    <div class="field-group">
                        <label for="project_migaq_kee_koox">3. Project Migaq Kee Koox:</label>
                        <div class="input-wrapper">
                            <input type="text" id="project_migaq_kee_koox" name="project_migaq_kee_koox" value="<?php echo htmlspecialchars($transaction['budget_owners']); ?>">
                        </div>
                    </div>
 <!-- for 4. Taamabeyni Migaq: is the variable "employee_name" set it's content with bold text -->          
                    <div class="field-group">
  ...
  <!-- for Qasbikinnihgide: is the variable "employee_salary" set it's content with bold text, this text is writen on the same line with 4. Taamabeyni Migaaqa but align to the right side not on the new line-->                          
                    <div class="field-group">
...
<!-- for 5. Safar Sababa: Set Fixed Lable "Madab Taama" with bold text, the variable text is is not found in the database -->

                    <div class="field-group">
                        <label for="safar_sababa">5. Safar Sababa:</label>
                        <div class="input-wrapper">
                            <input type="text" id="safar_sababa" name="safar_sababa" value="Madab Taama">
                        </div>
                    </div>
<!-- for 6. Ugtuma Araca set fixed Text "ሰመራ"  becaus it means the Departure City it is always ሰመራ since our bureau is found in ሰመራ  -->
                    <div style="display: flex; gap: 40px;">
                        <div class="field-group" style="flex:1;">
                            <label for="ugtuma_araca">6. Ugtuma Araca:</label>
                            <div class="input-wrapper">
                                <input type="text" id="ugtuma_araca" name="ugtuma_araca" value="<?php echo htmlspecialchars($transaction[' ']); ?>">
                            </div>
<!-- for Eddecaboh Araca: set "name_amharic" from cities cities table but city_idin perdium_transactions table linked with foreign key, and it should be to the right side with 6. Ugtuma Araca in the same line-->                        
                        </div>
                        <div class="field-group" style="flex:1;">
                            <label for="eddecaboh_araca">Eddecaboh Araca:</label>
                            <div class="input-wrapper">
                                <input type="text" id="eddecaboh_araca" name="eddecaboh_araca" value="<?php echo htmlspecialchars($transaction['City']); ?>">
                            </div>
                        </div>
                    </div>
<!-- for  8. Safarat Sugahgide set variable "departure_date" with bold text -->                
                    <div style="display: flex; gap: 40px;">
                        <div class="field-group" style="flex:1;">
                    ...
                    <div style="margin-left: 20px; margin-top: 20px;">
                        ...
                        <div style="margin-left: 20px; margin-top: 10px;">
                            <div class="field-group">
<!-- for  B. B. Ayrohaassenta set variable "perdium_rate" with bold text -->                    
...
<!-- for  T. Sirag le lee: set no variable because it asks if there is a Fuel payment you can set "0.00" with bold text -->                               
                            <div class="field-group">
                                <label for="sirag_le_lee">T. Sirag le lee:</label>
                                <div class="input-wrapper">
                                    <input type="text" id="sirag_le_lee" name="sirag_le_lee" value="<?php echo number_format($D, 2); ?>">
                                </div>
                            </div>
<!-- for  S. Foxomigi: set no variable because it asks if there is a Fuel payment you can set "0.00" with bold text -->                                 
                            <div style="display: flex; gap: 40px;">
                               <div class="field-group" style="flex:1;">
            ...
            <div class="page" id="page2">
                <header>
                 ...
                 <section class="sub-header-fields">
                    <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="kood" name="kood" value="<?php echo htmlspecialchars($transaction['owner_code']); ?>">
                        </div>
                    </div>
                    <div class="field-group">
                ...
                <main>
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="qasbi_kinnihgide_2" name="qasbi_kinnihgide_2" value="<?php echo htmlspecialchars($transaction['employee_directorate']); ?>">
                        </div>
                    </div>
                    <div class="field-group">
                        <label for="merraytu">Merraytu:</label>
                        <div class="input-wrapper">
                            <input type="text" id="merraytu" name="merraytu" value="<?php echo htmlspecialchars($transaction['employee_salary']); ?>">
                        </div>
                    </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td><input type="text" name="mekla[0][arac]" value="<?php echo htmlspecialchars($transaction['city_name_amharic']); ?>"></td>
                                <td><input type="date" name="mekla[0][ayro]" value="<?php echo htmlspecialchars($departure_date); ?>"></td>
                                <td><input type="text" name="mekla[0][saaqat]"></td>
                                <td><input type="number" name="mekla[0][kuraq]" value="<?php echo number_format($perdium_rate * 0.1, 2); ?>"></td>
                                <td><input type="number" name="mekla[0][kada]" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>"></td>
                                <td><input type="number" name="mekla[0][diraar]" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>"></td>
                                <td><input type="number" name="mekla[0][ayro_manga]" value="1"></td>
                                <td><input type="number" name="mekla[0][ayro_assenta]" value="<?php echo number_format($A, 2); ?>"></td>
                                <td><input type="number" name="mekla[0][ximmo]" readonly value="<?php echo number_format($A, 2); ?>"></td>
                            </tr>
                            <?php for ($i = 2; $i <= $total_days - 1; $i++): ?>
                            <tr>
                                <td><?php echo $i; ?>.</td>
                                <td><input type="text" name="mekla[<?php echo $i-1; ?>][arac]" value="<?php echo htmlspecialchars($transaction['city_name_amharic']); ?>"></td>
                                <td><input type="date" name="mekla[<?php echo $i-1; ?>][ayro]"></td>
                                <td><input type="text" name="mekla[<?php echo $i-1; ?>][saaqat]"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][kuraq]"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][kada]"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][diraar]"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][ayro_manga]" value="1"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][ayro_assenta]" value="<?php echo number_format($A, 2); ?>"></td>
                                <td><input type="number" name="mekla[<?php echo $i-1; ?>][ximmo]" readonly value="<?php echo number_format($A, 2); ?>"></td>
                            </tr>
                            <?php endfor; ?>
                            <tr>
                                <td><?php echo $total_days; ?>.</td>
                                <td><input type="text" name="mekla[<?php echo $total_days-1; ?>][arac]" value="<?php echo htmlspecialchars($transaction['city_name_amharic']); ?>"></td>
                                <td><input type="date" name="mekla[<?php echo $total_days-1; ?>][ayro]" value="<?php echo htmlspecialchars($arrival_date); ?>"></td>
                                <td><input type="text" name="mekla[<?php echo $total_days-1; ?>][saaqat]"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][kuraq]" value="<?php echo number_format($perdium_rate * 0.1, 2); ?>"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][kada]" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][diraar]" value="<?php echo number_format($perdium_rate * 0.25, 2); ?>"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][ayro_manga]" value="1"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][ayro_assenta]" value="<?php echo number_format($A, 2); ?>"></td>
                                <td><input type="number" name="mekla[<?php echo $total_days-1; ?>][ximmo]" readonly value="<?php echo number_format($A, 2); ?>"></td>
                            </tr>
                            <tr class="row-total">
                                <td colspan="9" style="text-align: right; padding-right: 10px;">Sittat</td>
                                <td><input type="number" name="mekla_total_ximmo" readonly value="<?php echo number_format($A + $B + $C, 2); ?>"></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <p style="font-weight: bold; margin-top: 20px;">B. Taamabeyni Safaral Sugahgide Kee Ayroca (Kaqaada) Qadoosa Qarwali</p>
                     <table class="data-table">
                        <thead>
                         ...
                         <tbody>
                            <tr>
                                <td><input type="date" name="qarwali[0][qinboh_ayro]" value="<?php echo htmlspecialchars($departure_date); ?>"></td>
                                <td><input type="date" name="qarwali[0][ellecabo_ayro]" value="<?php echo htmlspecialchars($arrival_date); ?>"></td>
                                <td><input type="text" name="qarwali[0][araca]" value="<?php echo htmlspecialchars($transaction['city_name_amharic']); ?>"></td>
                                <td><input type="number" name="qarwali[0][ayro_manga]" value="<?php echo htmlspecialchars($total_days-1); ?>"></td>
                                <td><input type="number" name="qarwali[0][ayro_assenta]" value="<?php echo number_format($perdium_rate * 0.4, 2); ?>"></td>
                                <td><input type="number" name="qarwali[0][ximmo]" readonly value="<?php echo number_format($D, 2); ?>"></td>
                            </tr>
                         </tbody>
                    </table>
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
                        <div style="width: 40%;">
                            <div class="field-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" id="a_kee_b_sittat" name="a_kee_b_sittat" readonly value="<?php echo number_format($A + $B + $C, 2); ?>">
                                </div>
                            </div>
                            <div class="field-group">
                                <label for="silaglelee">Silaglelee</label>
                                <div class="input-wrapper">
                                    <input type="number" id="silaglelee" name="silaglelee" readonly value="<?php echo number_format($D, 2); ?>">
                                </div>
                            </div>
                            <div class="field-group">
                            ...
                            <div class="field-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" id="sittat_final" name="sittat_final" readonly value="<?php echo number_format($total_amount, 2); ?>">
                                </div>
                            </div>
                        </div>
                    </div>

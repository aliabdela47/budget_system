        ...
        <div class="p-5">
            ...
            <ul class="space-y-2">
                ...
                <?php if ($_SESSION['role'] == 'admin'): ?>
                    ...
                    <li>
                        <a href="settings_codes.php" class="flex items-center p-3 text-base font-normal rounded-lg text-white bg-white/20">
        ...
        <div class="p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 p-6 bg-white rounded-xl shadow-sm">
                <div>
                    ...
                    <p class="text-slate-600 mt-2">Add and manage budget codes</p>
                </div>
            ...
            <div class="bg-white rounded-xl p-6 card-hover mb-8">
                <h2 class="text-xl font-bold text-slate-800 mb-6">Budget Code Form</h2>
            ...
            <div class="bg-white rounded-xl p-6 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-bold text-slate-800">Existing Budget Codes</h2>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($codes as $index => $c): ?>
                                <tr class="border-b border-slate-200 hover:bg-slate-50">
                                    <td class="px-4 py-2 font-medium"><?php echo $c['code']; ?></td>
                                    <td class="px-4 py-2"><?php echo htmlspecialchars($c['name']); ?></td>
                                    <td class="px-4 py-2">
                                        <div class="flex justify-center space-x-2">
                                            <a href="?action=edit&id=<?php echo $c['id']; ?>" class="btn-secondary btn-sm">
                                                <i class="fas fa-edit mr-1"></i> Edit
                                            </a>
                                            <a href="?action=delete&id=<?php echo $c['id']; ?>" class="btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this code?')">

...
--
-- Host: localhost
-- Generation Time: Sep 08, 2025 at 02:57 AM
...
INSERT INTO `budgets` (`id`, `owner_id`, `code_id`, `adding_date`, `year`, `yearly_amount`, `month`, `monthly_amount`, `quarter`, `remaining_yearly`, `remaining_monthly`, `remaining_quarterly`, `is_yearly`, `parent_id`, `allocated_amount`, `spent_amount`) VALUES
(1, 5, 5, '2025-09-07 00:00:00', 2017, 100000.00, '', 0.00, 0, 68800.00, 0.00, 0.00, 0, NULL, 0.00, 0.00),
(2, 5, 5, '2025-09-07 00:00:00', 2017, 0.00, 'መስከረም', 15000.00, 1, 85000.00, 0.00, 45000.00, 0, NULL, 0.00, 0.00),
(3, 5, 6, '2025-09-07 00:00:00', 2017, 200000.00, '', 0.00, 0, 180000.00, 0.00, 0.00, 0, NULL, 0.00, 0.00),
(4, 5, 6, '2025-09-07 00:00:00', 2017, 0.00, 'መስከረም', 20000.00, 1, 180000.00, 20000.00, 60000.00, 0, NULL, 0.00, 0.00),
(5, 5, 5, '2025-09-07 00:00:00', 2017, 0.00, 'ጥቅምት', 15000.00, 1, 68800.00, 3000.00, 45000.00, 0, NULL, 0.00, 0.00),
(7, 5, 7, '2025-09-07 00:00:00', 2017, 12000.00, '', 0.00, 0, 9500.00, 0.00, 0.00, 0, NULL, 0.00, 0.00),
(8, 5, 7, '2025-09-07 00:00:00', 2017, 0.00, 'መስከረም', 1150.00, 1, 9500.00, 2500.00, 7500.00, 0, NULL, 0.00, 0.00),
(10, 37, 20, '2025-09-07 21:28:27', 2017, 100000.00, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, NULL, 25000.00, 5000.00),
(11, 37, 20, '2025-09-07 21:28:27', 2017, 0.00, 'መስከረም', 25000.00, 1, 0.00, 0.00, 0.00, 0, 10, 20000.00, 5000.00),
(12, 37, 20, '2025-09-07 21:45:41', 2017, 100000.00, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, NULL, 0.00, 0.00),
(14, 13, 5, '2025-09-07 00:00:00', 2017, 150000.00, '', 0.00, 0, 111000.00, 0.00, 0.00, 0, NULL, 0.00, 0.00),
(16, 13, 5, '2025-09-07 00:00:00', 2017, 0.00, 'መስከረም', 13000.00, 1, 137000.00, 0.00, 39000.00, 0, NULL, 0.00, 0.00),
(17, 13, 5, '2025-09-07 00:00:00', 2017, 0.00, 'ጥቅምት', 13000.00, 2, 124000.00, 13000.00, 39000.00, 0, NULL, 0.00, 0.00),
(18, 13, 5, '2025-09-07 00:00:00', 2017, 0.00, 'ህዳር', 13000.00, 2, 111000.00, 13000.00, 39000.00, 0, NULL, 0.00, 0.00),
(20, 13, 6, '2025-09-07 00:00:00', 2017, 150000.00, '', 0.00, 0, 110000.00, 0.00, 0.00, 0, NULL, 0.00, 0.00),
(21, 13, 6, '2025-09-07 00:00:00', 2017, 0.00, 'መስከረም', 13000.00, 1, 137000.00, 7073.45, 39000.00, 0, NULL, 0.00, 0.00),
(22, 13, 6, '2025-09-07 00:00:00', 2017, 0.00, 'ሐምሌ', 10000.00, 1, 127000.00, 10000.00, 30000.00, 0, NULL, 0.00, 0.00),
(23, 13, 6, '2025-09-07 00:00:00', 2017, 0.00, 'ነሐሴ', 17000.00, 1, 110000.00, 17000.00, 51000.00, 0, NULL, 0.00, 0.00);
...
INSERT INTO `fuel_transactions` (`id`, `owner_id`, `p_koox`, `driver_name`, `plate_number`, `et_month`, `previous_gauge`, `current_gauge`, `journey_distance`, `fuel_price`, `refuelable_amount`, `total_amount`, `new_gauge`, `gauge_gap`, `date`) VALUES
(42, 5, '341/01/01', 'grf', '4-01265', 'መስከረም', 0.00, 0.00, 200.00, 120.00, 40.00, 4800.00, 200.00, 200.00, '2025-09-07 04:20:03'),
(43, 5, '341/01/01', 'kk', '4-01265', 'ጥቅምት', 200.00, 200.00, 50.00, 120.00, 10.00, 1200.00, 250.00, 50.00, '2025-09-07 04:21:26'),
(44, 5, '341/01/01', 'mjm', '4-01265', 'መስከረም', 250.00, 250.00, 150.00, 120.00, 30.00, 3600.00, 400.00, 150.00, '2025-09-07 04:25:59'),
(45, 5, '341/01/01', 'kmkm', '4-01265', 'መስከረም', 400.00, 400.00, 275.00, 120.00, 55.00, 6600.00, 675.00, 275.00, '2025-09-07 04:29:03'),
(46, 5, '341/01/01', 'ndh', '4-01264', 'ጥቅምት', 0.00, 0.00, 500.00, 120.00, 100.00, 12000.00, 500.00, 500.00, '2025-09-07 04:33:43'),
(47, 13, '341/07/25', 'ghhh', '4-01264', 'መስከረም', 500.00, 500.00, 200.00, 120.00, 40.00, 4800.00, 700.00, 200.00, '2025-09-07 22:28:35'),
(48, 13, '341/07/25', 'knj', '4-01265', 'መስከረም', 675.00, 675.00, 250.00, 120.00, 50.00, 6000.00, 925.00, 250.00, '2025-09-07 22:32:13'),
(49, 13, '341/07/25', 'hhh', '4-01265', 'መስከረም', 925.00, 925.00, 90.00, 120.00, 18.00, 2160.00, 1015.00, 90.00, '2025-09-07 22:34:15'),
(50, 13, '341/07/25', 'geuh', '4-01265', 'መስከረም', 1015.00, 1015.00, 5.00, 40.00, 1.00, 40.00, 1020.00, 5.00, '2025-09-07 22:37:08');
...
INSERT INTO `perdium_transactions` (`id`, `employee_id`, `budget_owner_id`, `p_koox`, `budget_code_id`, `city_id`, `perdium_rate`, `total_days`, `departure_date`, `arrival_date`, `total_amount`, `et_month`, `created_at`) VALUES
(1, 1, 13, '341/07/25', 6, 2, 413.00, 15, '2025-09-08', '2025-09-22', 5926.55, 'መስከረም', '2025-09-07 20:06:10');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `quarterly_budgets`  AS SELECT `budget_db`.`budgets`.`owner_id` AS `owner_id`, `budget_db`.`budgets`.`code_id` AS `code_id`, `budget_db`.`budgets`.`year` AS `year`, `budget_db`.`budgets`.`quarter` AS `quarter`, sum(`budget_db`.`budgets`.`monthly_amount`) AS `quarterly_allocated`, sum(`budget_db`.`budgets`.`spent_amount`) AS `quarterly_spent`, (sum(`budget_db`.`budgets`.`monthly_amount`) - sum(`budget_db`.`budgets`.`spent_amount`)) AS `quarterly_remaining` FROM `budget_db`.`budgets` WHERE (`budget_db`.`budgets`.`is_yearly` = FALSE) GROUP BY `budget_db`.`budgets`.`owner_id`, `budget_db`.`budgets`.`code_id`, `budget_db`.`budgets`.`year`, `budget_db`.`budgets`.`quarter` ;

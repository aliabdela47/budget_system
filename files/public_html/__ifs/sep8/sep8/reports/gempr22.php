        ...
        <div class="page page-break" id="page1">
            <header>
                <div class="main-header-box">
                    <div class="header-top">
                        ...
                        <div style="width: 45px; height: 45px; background-color: #ddd; display: flex; align-items: center; justify-content: center;">Flag</div>
                    ...
                    <div class="header-bottom">
                        <div>
                            <div class="field-group">
                                <label>Ixxima:</label>
                                <div class="value" style="width: 250px;">Finance Department</div>
                            </div>
                            <div class="field-group">
                                <label>Ayro:</label>
                                <div class="value" style="width: 250px;"><?php echo date('m/d/Y'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="sub-header-fields">
                <div class="field-group">
                    ...
                    <div class="value" style="width: 300px;">TRV-2023-0876</div>
                </div>
                <div class="field-group">
            ...
            <main>
                ...
                <div class="field-group"><label>2. Taamagoli:</label><div class="value">Ahmed Mohammed</div></div>
                <div class="field-group"><label>3. Project Migaq Kee Koox:</label><div class="value">Health Outreach Program</div></div>
                <div class="field-group"><label>4. Taamabeyni Migaq:</label><div class="value">Ahmed Mohammed</div></div>
                <div class="field-group"><label>5. Qasbikinnihgide:</label><div class="value">Health Officer</div></div>
                <div class="field-group"><label>6. Safar Sababa:</label><div class="value">Field visit to rural health centers</div></div>
                
                <div style="display: flex; gap: 40px;">
                    <div class="field-group" style="flex:1;"><label>7. Ugtuma Araca:</label><div class="value">08/15/2023</div></div>
                    <div class="field-group" style="flex:1;"><label>Eddecaboh Araca:</label><div class="value">08/20/2023</div></div>
                </div>
                <div style="display: flex; gap: 40px;">
                    <div class="field-group" style="flex:1;"><label>8. Safarat Sugahgide:</label><div class="value">5</div></div>
                    <div class="field-group" style="flex:1;"><label>Illa:</label><div class="value">Semera</div></div>
                </div>
                
                <div style="margin-left: 20px; margin-top: 20px;">
                    <label style="font-weight: bold; font-size: 1.1em;">9. Aakamah Mekleenim:</label>
                    <div style="margin-left: 20px; margin-top: 10px;">
                        <div class="field-group"><label>B. Ayrohaassenta:</label><div class="value">500.00 ETB</div></div>
                        <div class="field-group"><label>T. Sirag le lee:</label><div class="value">250.00 ETB</div></div>
                        <div style="display: flex; gap: 40px;">
                           <div class="field-group" style="flex:1;"><label>S. Foxomigi:</label><div class="value">50.00 ETB</div></div>
                           <div class="field-group" style="flex:1;"><label>Sittatmekleenim:</label><div class="value">800.00 ETB</div></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page" id="page2">
            ...
            <section class="sub-header-fields">
                <div class="field-group">
                    ...
                    <div class="value" style="width: 300px;">Travel Advance Request</div>
                </div>
                <div class="field-group">
                    <label>Print Date:</label>
                    <div class="value" style="border:none;"><?php echo date('m/d/Y'); ?></div>
            ...
            <main>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <!-- Sample data row -->
                        <tr>
                            <td class="row-header">Field visit to rural health centers</td>
                            <td>08/15/2023</td>
                            <td>08/20/2023</td>
                            <td>Daily</td>
                            <td>800.00</td>
                ...
                <div class="two-column-layout">
                    <div>
                        <div class="field-group"><label>Kood:</label><div class="value">TRV-2023-0876</div></div>
                        ...
                        <div class="field-group"><lable>Employee:</lable><?php echo $transaction['employee_name']; ?></div>
                        <div class="value">Ahmed Mohammed</div></label>
                        <div class="field-group"><label>Taamabeyni Migaq:</label><div class="value"><?php echo $transaction['employee_name']; ?></div></div>
                        <div class="field-group"><label>Qasbi kinnihgide:</label><div class="value"><?php echo $transaction['employee_salary']; ?></div></div>
                        <div class="field-group"><label>Merraytu:</label><div class="value">Health Outreach Program</div></div>
                        <div class="field-group"><label>Assenti Mekla:</label><div class="value">1000.00 ETB</div></div>
                    </div>
                ...
                <div class="summary-fields">
                    <div class="field-group"><label>A Kee B Sittat:</label><div class="value">800.00 ETB</div></div>
                    <div class="field-group"><label>Silaglelee:</label><div class="value">200.00 ETB</div></div>
                    <div class="field-group"><label>Foxomigi:</label><div class="value">50.00 ETB</div></div>
                    <div class="field-group"><label>Sittat:</label><div class="value">2500.00 ETB</div></div>
                </div>
            </main>
        </div>
    </div>

...
<div class="header-bottom">
    ...
    <div class="value">
        <span style="font-weight: bold; border-bottom: 1.5px solid #000; display: block; padding: 1px 3px;"><?php echo htmlspecialchars($transaction['employee_directorate']); ?></span>
    </div>
</div>

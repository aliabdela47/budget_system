  ...
  <div class="main-content" id="mainContent">
    <div class="p-6">
      ...
      <div class="bg-white rounded-xl p-6 card-hover mb-8">
        ...
        <form action="reports/fuel_report.php" method="GET" target="_blank" class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Start Date</label>
              <input type="date" name="start_date" class="input-group" value="<?php echo date('Y-m-01'); ?>">
            </div>
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">End Date</label>
              <input type="date" name="end_date" class="input-group" value="<?php echo date('Y-m-t'); ?>">
            </div>
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Budget Owner</label>
              <select name="owner_id" class="input-group">
          ...
          <div class="flex space-x-4">
            <button type="submit" name="format" value="html" class="btn-primary">
              <i class="fas fa-file-alt mr-2"></i> View HTML Report
            </button>
            <button type="submit" name="format" value="pdf" class="btn-info">

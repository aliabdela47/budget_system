...
// Modify the Select2 initialization to include custom matcher for employees
$('.select2').select2({
    theme: 'classic',
    width: '100%',
    matcher: function(params, data) {
        ...
        // For employee dropdown specifically, check name_af data attribute
        if (data.element && $(data.element).data('name-af')) {
            if ($(data.element).data('name-af').toLowerCase().indexOf(params.term.toLowerCase()) > -1) {
                return data;
            }
        }

        // Check if any other data attributes contain the term

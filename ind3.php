    ...
    <div class="w-full max-w-md">
        <div class="glass-card rounded-2xl shadow-2xl p-8 space-y-6 relative">
            ...
            <div id="login-form">
                ...
                <form method="post" action="" class="space-y-6 mt-4" onsubmit="handleLoginSubmit(event)">
                    <div class="relative">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="checkbox-wrapper text-white/80">
                            <input type="checkbox" name="remember_"
                                   <?php echo $remembered_user ? 'checked' : ''; ?>>
                            <span class="checkmark"></span>
                            Remember me
                        </label>
                        <a href="?action=forgot_password" class="forgot-password-link font-medium text-white/80 hover:text-white">Forgot Password?</a>
                    </div>
                    <div>
                ...
                <form method="post" action="?action=forgot_password" class="space-y-6 mt-6" onsubmit="handleForgotPasswordSubmit(event)">
                    ...
                    <div>
                     ...
                     <div class="text-center">
                        <a href="./" class="font-medium text-sm text-white/80 hover:text-white">&larr; Back to Login</a>
                    </div>
                </form>
            </div>
            <?php endif; ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            langSwitcher.addEventListener('change', (e) => {
                ...
                if (loginForm) {
                    ...
                    document.querySelector('.checkbox-wrapper').lastChild.textContent = ' ' + t.rememberMe;

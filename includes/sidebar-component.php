...
?>
<!-- Sidebar Component -->
<div class="sidebar" id="sidebarComponent">
...
/* Sidebar Component Styles - UPDATED STRUCTURE */
.sidebar {
    width: 280px;
...
.sidebar-inner {
    ...
    flex-direction: column;
    height: 100%;
    overflow-y: auto; /* Enable scrolling for entire sidebar content */
}
...
.nav-menu {
    ...
    /* Remove overflow-y: auto - let the entire sidebar-inner scroll */
}
...
/* Scrollbar Styling - UPDATED for sidebar-inner */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Search data - in a real app, this would come from the server
    const searchData = [

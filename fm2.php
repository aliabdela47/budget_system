    ...
    <div class="p-6">
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm mb-8">
        ...
        <form id="fuelForm" method="POST" class="space-y-4" onsubmit="return validateBeforeSubmit();">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Plate Number | ታርጋውን ሴሌክት አርግ*</label>
            ...
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Driver Name | የአሽከርካሪው ስም*</label>

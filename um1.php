                        ...
                        <tbody>
                            <?php foreach ($users as $index => $u): ?>
                                <tr class="border-b border-slate-200 table-row-hover">
                                    ...
                                    <td class="px-4 py-3 font-medium"><?php echo $u['id']; ?></td>
                                    <td class="px-4 py-3"><?php echo htmlspecialchars($u['username']); ?></td>
                                    <td class="px-4 py-3"><?php echo htmlspecialchars($u['name']); ?></td>
                                    <td class="px-4 py-3">
                                        <span class="status-badge <?php echo $u['role'] == 'admin' ? 'status-admin' : 'status-officer'; ?>">
                                            <?php echo $u['role']; ?>
                                        </span>
                                    </td>
                                    <td class="px-4 py-3">
